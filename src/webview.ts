    ...
    try {
      ...
      const initPrompt: OpenAI.Chat.Completions.ChatCompletionMessageParam = {
        ...
        content: `You are to enhance coding skills by helping users identify and address issues in their approach to solving programming problems.
           ...
           Based on these inputs, you must analyze the provided information and respond with only the following three elements:
             ...
             3. Each guiding question should have a dropdown, both expandable and collapsible, that contains the details of implementation based on the guiding question.
            Important Guidelines: 
             ...
             - Provide a two-sentence summary instead of the first results.`,
      };
